<?php
    ...
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}cc-banner.jpg","jogo"=>"{$caminho}crimsonCurse");

    $games[1] = array("id"=>2, "nome"=>"Cyber Gun", "descricao"=>"<p></p>",
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}cg-banner.jpg");

    $games[2] = array("id"=>3, "nome"=>"Desordeon", "descricao"=>"<p></p>",
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}des-banner.jpg");

    $games[3] = array("id"=>4, "nome"=>"Flying Chicken", "descricao"=>"<p></p>",
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}fc-banner.jpg");

    $games[4] = array("id"=>5, "nome"=>"Meowtopia", "descricao"=>"<p></p>",
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}mw-banner.jpg");

    $games[5] = array("id"=>6, "nome"=>"Omega Collapse", "descricao"=>"<p></p>",
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"{$path}oc-banner.jpg");
